...
btn_labels = [
	...
	"leaderboard set_score (absolute rnd)",
...
function talo_demo_run_action(_idx) {
	switch (_idx) {
		...
		case 15:
			...
			break;
		case 16:
			TaloSDK_leaderboard_entries_set_score(leaderboard_internal_name, irandom(999999));
			break;
		case 17: TaloSDK_leaderboard_entries_add_score(leaderboard_internal_name, 5); break;
		case 18: {
			var evjson = "[{\"name\":\"talo_gm_demo\",\"props\":[{\"key\":\"client\",\"value\":\"GameMaker\"}]}]";
			TaloSDK_events_track(evjson);
			break;
		}
		case 19: TaloSDK_game_saves_list(); break;
		case 20: {
			var payload = {
		...
		case 22:
			...
			break;
		case 23: TaloSDK_game_stats_player_stats(); break;
		case 24: {
		...
		case 28: TaloSDK_players_create_socket_token(); break;
		case 29: TaloSDK_socket_tickets_create(); break;
		case 30: {
			var pid = TaloSDK_get_last_player_id();
			if (pid == "") talo_demo_log("Нет player id.");
		...
		case 32:
			...
			break;
		case 33: TaloSDK_players_relationships_subscribers("page=0"); break;
		case 34: TaloSDK_players_relationships_subscriptions("page=0"); break;
		case 35:
...
talo_demo_log("Лидерборд: \"" + leaderboard_internal_name + "\" — POST score, set_score (абсолют), add_score (+5).");
